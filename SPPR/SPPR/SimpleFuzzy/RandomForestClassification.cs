...
namespace SPPR
{
    public partial class RandomForestClassification : UserControl
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            RandomForest tree = new RandomForest(train, (int)numericUpDown2.Value, (int)numericUpDown4.Value, (int)numericUpDown5.Value, (int)numericUpDown3.Value, TreeRule.now);
            ...
            for (int i = 0; i < test.Length; i++)
            {
                ...
                int res = tree.GetClass(test[i].Item1, checkBox1.Checked);
                if (res == test[i].Item2)
                    trueCount++;
