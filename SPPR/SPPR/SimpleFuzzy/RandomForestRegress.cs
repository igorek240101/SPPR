...
namespace SPPR
{
    public partial class RandomForestRegress : UserControl
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            numericUpDown6.Maximum = TrainCollection.GetLength(1) - 1;
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            RegressForest tree = new RegressForest(train, (int)numericUpDown2.Value, (int)numericUpDown4.Value, (int)numericUpDown5.Value, (int)numericUpDown3.Value, TreeRule.now);
            ...
            for (int i = 0; i < test.Length; i++)
            {
                ...
                res[i] = tree.GetValue(test[i].Item1, checkBox1.Checked);
        ...
        private void RePaint()
        {
            ...
            for (int i = 0; i < TestCollection.GetLength(0); i++)
            {
                lineSeries.Points.Add(new ScatterPoint(
                    TestCollection[i, (int)numericUpDown6.Value] is double ? (double)TestCollection[i, (int)numericUpDown6.Value] : 0,
                    res[i], 2));
                ls.Points.Add(new ScatterPoint(
                    TestCollection[i, (int)numericUpDown6.Value] is double ? (double)TestCollection[i, (int)numericUpDown6.Value] : 0,
            ...
            for (int i = 0; i < TestCollection.GetLength(0); i++)
            {
                loss.Points.Add(new ScatterPoint(TestCollection[i, (int)numericUpDown6.Value] is double ? (float)(double)TestCollection[i, (int)numericUpDown6.Value] : 0, res[i] - (float)(double)TestCollection[i, 0], 1));
            }
